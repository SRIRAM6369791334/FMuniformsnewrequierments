                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; max-width: 600px;">
                    ...
                    <tr>
                        <td style="padding: 0 20px;">
                            <h2 style="text-align: center; color: #00274D; margin: 20px 0;">New Bulk Order Request</h2>
                            <p style="text-align: center; font-size: 14px; color: #666666; margin: 10px 0 30px 0;">
                                A new bulk order request has been received on FM Uniforms. Please review and contact the customer with a quote as soon as possible.
                            </p>
                        </td>
                    </tr>
                        ...
                        <td style="padding: 0 20px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border: 1px solid #e5e7eb; margin: 20px 0;">
                                <tr style="background-color: #fafafa;">
                                    ...
                                    <td style="padding: 12px 15px; border: 1px solid #e5e7eb;">{{ $bulkOrder->first_name }} {{ $bulkOrder->last_name ?? '' }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 15px; border: 1px solid #e5e7eb; font-weight: 600;">Email</td>
                                    <td style="padding: 12px 15px; border: 1px solid #e5e7eb;">{{ $bulkOrder->email }}</td>
                                </tr>
                                <tr style="background-color: #fafafa;">
                    ...
                    <tr>
                        <td style="padding: 0 20px; text-align: center;">
                            <a href="{{ url('/admin/bulk-orders') }}" style="display: inline-block; background-color: #e11e12; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 4px; margin: 20px 0;">View Bulk Orders</a>
                        </td>
                    </tr>
