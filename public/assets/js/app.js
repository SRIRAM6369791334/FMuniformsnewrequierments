...
(function ($) {
  ...
  THEMEIM.initialize = {
    ...
    general: function () {
      ...
      $(".qtybutton").on("click", function () {
        ...
        var maxVal = parseFloat($input.attr("max")) || Infinity;
      ...
      /*---------------------
         Product Zoom (Venobox)
         --------------------- */

      // Initialize venobox for product zoom
      $('.venobox').venobox({
        numeratio: true,
        infinigall: true,
      ...
      // Set href dynamically for zoom links
      $('.pro-icon .venobox').each(function () {
        var productImg = $(this).closest('.sin-product').find('.pro-img img').attr('src');
        $(this).attr('href', productImg);
      });
  ...
  THEMEIM.documentOnLoad = {
    init: function () {
      ...
      // Remove automatic modal showing to prevent aria-hidden issues
